...
function processSupplierEdit(req, res){
	...
	Suppliers.findByIdAndUpdate(req.body.supplierId,
					{$set: {
						...
						supplierFB: req.body.supplierFB,
						supplierTw: req.body.supplierTw,
						supplierInst: req.body.supplierInst,
	...
	Suppliers.findOne({ supplierName: req.params.supplierName})
		...
		if (err) {
			...
			var context = {
				...
				supplierFB: supplier.supplierFB,
				supplierTw: supplier.supplierTw,
				supplierInst: supplier.supplierInst,
